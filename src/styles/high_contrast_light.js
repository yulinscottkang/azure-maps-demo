var style_high_contrast_light = {
	...
	"sources": {
		"bing-mvt": {
			"type": "vector",
			"url": "https://{{azMapsDomain}}/map/tileset?api-version=2.1&language={{azMapsLanguage}}&view={{azMapsView}}&tilesetId=microsoft.base&cstl=hcl&sv=9.03&og=1122"
			// "tiles": ["https://ecn.api.m2.tiles.live-int.com/comp/ch/{z}-{x}-{y}.mvt?mkt=en-us&it=G,LC,L,LA&og=1122&src=t&js=1&tj=1&ur=us&cstl=hcl&mvt=1&features=mvt,mvtfontinfo&sv=9.03"],
			// "promoteId": "id",
			// "minzoom": 0,
			// "maxzoom": 18
		},
		"bing-traffic": {
			...
			// "tiles": [
			// 	"https://trafficrenderer.tiles.virtualearth.net/comp/ch/{quadkey}?it=Z,TF&src=t&cstl=hcl&mvt=1"
			// ],
			// "minzoom": 6,
			// "maxzoom": 20
		},
		"roadDetails": {
			"type": "raster",
			"url": "https://{{azMapsDomain}}/map/tileset?api-version=2.1&language={{azMapsLanguage}}&view={{azMapsView}}&tilesetId=microsoft.core.raster.roaddetail&cstl=hcl",
			// "tiles": ["https://ecn.dynamic.t0.m2.tiles.live-int.com/comp/ch/{quadkey}?mkt=en-US&it=g&og=1674&cstl=hcl&stl=d"],
			// "minzoom": 5,
			// "maxzoom": 13,
			// "tileSize": 256
		},
		"buildings": {
			"type": "raster",
			"url": "https://{{azMapsDomain}}/map/tileset?api-version=2.1&language={{azMapsLanguage}}&view={{azMapsView}}&tilesetId=microsoft.core.raster.buildingfootprint&cstl=hcl",
			// "tiles": ["https://ecn.dynamic.t0.m2.tiles.live-int.com/comp/ch/{quadkey}?mkt=en-US&it=z,bf&og=1674&cstl=hcl&n=t"],
			// "minzoom": 16,
			// "maxzoom": 20,
			// "tileSize": 256
		},
		"JK": {
			"type": "raster",
			"url": "https://{{azMapsDomain}}/map/tileset?api-version=2.1&language={{azMapsLanguage}}&view={{azMapsView}}&tilesetId=microsoft.core.raster.highcontrastlight",
	...
	"sprite": "https://ecn.api.m2.tiles.live-int.com/comp/stl/sprite?ods=mvt&mbxs=51609bf5-dcd1-4d5a-8dfe-e0813dae90a4&v=9.03&og=1674&mkt=en-US",
	...
	"layers": [{
		...
		"paint": {
			...
			"fill-color": ["interpolate", ["linear"],
				["zoom"], 4, "hsla(39, 22%, 82%, 0)", 22, "hsla(39, 22%, 80%, 0)"
			]
		}
	}, {
		...
		"paint": {
			"fill-color": ["interpolate", ["linear"],
				["zoom"], 0, "hsl(0, 0%, 78%)", 13, "hsl(0, 0%, 78%)", 22, "hsl(0, 0%, 78%)"
			]
		}
	}, {
		...
		"type": "fill",
		"paint": {
			"fill-color": ["step", ["zoom"], "hsl(120, 52%, 49%)", 11, "hsl(120, 54%, 44%)"]
		}
	}, {
		...
		"paint": {
			"fill-color": ["match", ["get", "bkt"],
				[2026, 2025, 2021], "hsl(0, 0%, 100%)", 2029, "hsl(48, 100%, 40%)", "hsl(120, 60%, 42%)"
			]
		}
	}, {
		...
		"paint": {
			"fill-color": ["interpolate", ["linear"],
				["zoom"], 0, "hsl(0, 4%, 75%)", 10, "hsl(0, 0%, 73%)", 15, "hsl(0, 0%, 70%)"
			]
		}
	}, {
		...
		"paint": {
			...
			"line-width": ["step", ["zoom"], 0.38, 14, 0.56, 15, 3.75, 16, 6.0, 17, 10.5, 18, 15.0, 19, 19.5, 20, 21.0, 21, 24.0]
		}
	}, {
		...
		"paint": {
			"line-color": "hsl(0, 0%, 46%)",
			"line-width": ["interpolate", ["linear"],
				["zoom"], 13, 0.49, 14, 0.71, 15, 4.62, 16, 7.2, 17, 12.25, 18, 17.0, 22, 15.0
			]
		}
	}, {
		...
		"paint": {
			"line-color": ["step", ["zoom"], "hsl(0, 0%, 26%)", 13, "hsl(0, 0%, 53%)"],
		...
		"paint": {
			"line-color": ["step", ["zoom"], "hsl(0, 0%, 100%)", 9, "hsl(0, 0%, 26%)", 13, "hsl(0, 0%, 53%)"],
			"line-width": ["step", ["zoom"], 1.0, 6, 2.0, 8, 2.5, 9, 3.0, 12, 3.6, 13, 4.2, 14, 5.0, 15, 10.0, 16, 18.0, 17, 28.0]
		}
	}, {
		...
		"paint": {
			"line-color": ["match", ["get", "bkt"], 685, "hsl(0, 0%, 26%)", "hsl(0, 0%, 54%)"],
			"line-width": ["interpolate", ["linear"],
				["zoom"], 13, 0.49, 14, 0.71, 15, 4.62, 16, 7.2, 17, 12.25, 18, 17.0, 22, 15.0
			]
		}
		...
		"paint": {
			"line-color": ["match", ["get", "bkt"],
				[631, 635, 1349], "hsl(0, 0%, 53%)", "hsl(0, 0%, 26%)"
			],
		...
		"paint": {
			...
			"line-width": ["interpolate", ["linear"],
				["zoom"], 13, 0.43, 14, 0.63, 15, 4.15, 16, 6.55, 17, 11.3, 18, 15.91, 19, 21.95, 20, 25.5, 21, 28.93, 22, 28.5
			]
		}
	}, {
		...
		"paint": {
			"line-color": ["interpolate", ["linear"],
				["zoom"], 0, "hsl(0, 0%, 53%)", 14, "hsl(0, 0%, 53%)", 15, "hsl(24, 23%, 95%)"
			],
		...
		"paint": {
			"line-color": ["match", ["get", "bkt"], 685, "hsl(0, 0%, 100%)", "hsl(0, 0%, 88%)"],
			"line-width": ["step", ["zoom"], 2.25, 16, 4.5, 17, 9.0, 18, 13.5]
		}
	}, {
		...
		"paint": {
			"line-color": ["match", ["get", "bkt"], 1309, "hsl(0, 0%, 88%)", "hsl(0, 0%, 100%)"],
			"line-width": ["step", ["zoom"], 1.0, 12, 2.0, 13, 3.0, 14, 5.5, 15, 8.0, 16, 16.0, 17, 26.0, 18, 28.0, 19, 32.0, 20, 36.0, 21, 38.0]
		}
	}, {
		...
		"paint": {
			"line-color": "hsla(0, 0%, 26%, 0.5)",
			"line-width": ["step", ["zoom"], 1.5, 17, 2.25, 18, 3.0]
		}
	}, {
		...
		"paint": {
			"line-color": "hsl(0, 0%, 100%)",
			"line-width": ["step", ["zoom"], 2.25, 16, 4.5, 17, 9.0, 18, 13.5, 19, 18.0, 20, 21.0, 21, 25.5]
		}
	}, {
		...
		"paint": {
			"line-color": "hsl(0, 0%, 100%)",
			"line-width": ["step", ["zoom"], 2.62, 16, 4.5, 17, 9.0, 18, 13.5, 19, 18.0, 20, 21.0, 21, 25.5]
		}
	}, {
		...
		"paint": {
			"line-color": ["interpolate", ["linear"],
				["zoom"], 6, "hsla(0, 0%, 38%, 0.9)", 8, "hsla(0, 0%, 38%, 0.9)", 10, "hsl(0, 0%, 53%)"
			],
			"line-width": ["interpolate", ["linear"],
		...
		"paint": {
			"line-color": ["interpolate", ["linear"],
				["zoom"], 0, "hsl(0, 0%, 53%)", 15, "hsl(0, 0%, 49%)"
			],
			"line-width": 3.0,
		...
		"paint": {
			"line-color": ["interpolate", ["linear"],
				["zoom"], 6, "hsl(24, 23%, 85%)", 8, "hsl(24, 23%, 85%)", 10, "hsl(24, 23%, 95%)"
			],
			"line-width": ["interpolate", ["linear"],
		...
		"paint": {
			"line-color": ["interpolate", ["linear"],
				["zoom"], 6, "hsla(0, 0%, 43%, 0.9)", 8, "hsla(0, 0%, 43%, 0.9)", 10, "hsl(0, 0%, 53%)"
			],
			"line-width": ["interpolate", ["linear"],
		...
		"paint": {
			"line-color": ["match", ["get", "bkt"], 1308, "hsl(0, 0%, 54%)", "hsl(0, 0%, 26%)"],
			"line-width": ["step", ["zoom"], 1.0, 6, 2.0, 8, 2.5, 9, 3.0, 12, 3.6, 13, 4.2, 14, 5.0, 15, 10.0, 16, 18.0, 17, 28.0, 18, 32.0, 19, 40.0, 20, 44.0, 21, 48.0]
		}
	}, {
		...
		"paint": {
			"line-color": ["step", ["zoom"], "hsl(0, 0%, 100%)", 9, "hsl(0, 0%, 26%)"],
			"line-width": ["step", ["zoom"], 1.0, 6, 2.0, 8, 2.5, 9, 3.0, 12, 3.6, 13, 4.2, 14, 5.0, 15, 10.0, 16, 18.0, 17, 28.0]
		}
	}, {
		...
		"paint": {
			"line-color": ["match", ["get", "bkt"], 1308, "hsl(0, 0%, 88%)", "hsl(0, 0%, 100%)"],
		...
		"paint": {
			"line-color": ["interpolate", ["linear"],
				["zoom"], 1, "hsla(0, 1%, 48%, 0.8)", 2, "hsl(0, 1%, 48%)"
			],
			"line-width": ["interpolate", ["linear"],
				["zoom"], 0, 4.0, 6, 6.0
			]
		...
		"paint": {
			"line-color": ["interpolate", ["linear"],
				["zoom"], 2, "hsla(0, 0%, 0%, 0.04)", 3, "hsla(0, 0%, 0%, 0.05)", 4, "hsla(0, 0%, 0%, 0.09)", 22, "hsla(0, 0%, 0%, 0.08)"
			],
			"line-width": ["interpolate", ["linear"],
				["zoom"], 2, 20.0, 3, 20.0, 4, 24.0, 5, 32.0, 6, 36.0, 7, 44.0, 9, 52.0, 13, 64.0
			]
		...
		"minzoom": 6,
		"paint": {
			"text-color": ["match", ["get", "st-et"], "ramp", "#000000", "controlledAccessHighway", "#000000", "highway", "#000000", "majorRoad", "#000000", "arterial", "#000000", "street", "#000000", "#252525"],
			"text-halo-width": 1.0,
			"text-halo-color": "hsl(0, 0%, 100%)"
		}
	}, {
		...
		"paint": {
			"text-color": "hsl(0, 0%, 100%)",
			"text-halo-width": 1.0,
			"text-halo-color": "hsl(240, 100%, 31%)"
		}
	}, {
		...
		"paint": {
			"text-color": ["step", ["zoom"], "hsl(0, 0%, 10%)", 2, "hsla(0, 0%, 10%, 0.2)"],
		...
		"paint": {
			...
			"text-color": ["match", ["get", "st-tag"], "shopping", ["case", ["boolean", ["feature-state", "hover"], false], "#000000", "#000000"], "essentialService", ["case", ["boolean", ["feature-state", "hover"], false], "#000000", "#000000"], "entertainment", ["case", ["boolean", ["feature-state", "hover"], false], "#000000", "#000000"], "food", ["case", ["boolean", ["feature-state", "hover"], false], "#000000", "#000000"], "community", ["case", ["boolean", ["feature-state", "hover"], false], "#000000", "#000000"], "attraction", ["case", ["boolean", ["feature-state", "hover"], false], "#000000", "#000000"], "realEstate", ["case", ["boolean", ["feature-state", "hover"], false], "#000000", "#000000"], "education", ["case", ["boolean", ["feature-state", "hover"], false], "#000000", "#000000"], "lodging", ["case", ["boolean", ["feature-state", "hover"], false], "#000000", "#000000"],
				["case", ["boolean", ["feature-state", "hover"], false], "#000000", "#000000"]
			],
			"text-halo-width": 1.0,
			"text-halo-color": "hsl(0, 0%, 100%)"
		}
		...
		"paint": {
			"text-color": ["case", ["boolean", ["feature-state", "hover"], false], "#000000", "#000000"],
			"text-halo-width": 1.0,
			"text-halo-color": "hsl(0, 0%, 100%)"
		}
	}, {
		...
		"paint": {
			"text-color": ["step", ["zoom"], "hsl(0, 0%, 14%)", 10, "hsla(0, 0%, 14%, 0.6)", 11, "hsla(0, 0%, 14%, 0.4)", 12, "hsla(0, 0%, 14%, 0.27)"]
		}
	}, {
