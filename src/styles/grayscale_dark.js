// https://ecn.api.m2.tiles.live-int.com/comp/stl?ods=mvt&mbxs=68C27B9C-4FB4-4CEC-A664-3FC3C2E8A12A&v=9.03&layers=d,b,ro&og=1674&mkt=en-US&ur=us&stlhost=int2
var style_grayscale_dark = {
	...
	"sources": {
		"bing-mvt": {
			"type": "vector",
			"url": "https://{{azMapsDomain}}/map/tileset?api-version=2.1&language={{azMapsLanguage}}&view={{azMapsView}}&tilesetId=microsoft.base&cstl=wd&sv=9.03&og=1122"
		...
		"bing-traffic": {
			...
			// "tiles": [
			// 	"https://trafficrenderer.tiles.virtualearth.net/comp/ch/{quadkey}?it=Z,TF&src=t&cstl=wd&mvt=1"
			// ],
			// "minzoom": 6,
			// "maxzoom": 20
		},
		"roadDetails": {
			"type": "raster",
			"url": "https://{{azMapsDomain}}/map/tileset?api-version=2.1&language={{azMapsLanguage}}&view={{azMapsView}}&tilesetId=microsoft.core.raster.roaddetail&cstl=wd",
		...
		"buildings": {
			"type": "raster",
			"url": "https://{{azMapsDomain}}/map/tileset?api-version=2.1&language={{azMapsLanguage}}&view={{azMapsView}}&tilesetId=microsoft.core.raster.buildingfootprint&cstl=wd",
		...
		"JK": {
			"type": "raster",
			"url": "https://{{azMapsDomain}}/map/tileset?api-version=2.1&language={{azMapsLanguage}}&view={{azMapsView}}&tilesetId=microsoft.core.raster.canvasdark",
