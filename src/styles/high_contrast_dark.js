...
var style_high_contrast_dark = {
	...
	"sources": {
		...
		"roadDetails": {
			"type": "raster",
			"url": "https://{{azMapsDomain}}/map/tileset?api-version=2.1&language={{azMapsLanguage}}&view={{azMapsView}}&tilesetId=microsoft.core.raster.roaddetail&cstl=hc",
		...
		"buildings": {
			"type": "raster",
			"url": "https://{{azMapsDomain}}/map/tileset?api-version=2.1&language={{azMapsLanguage}}&view={{azMapsView}}&tilesetId=microsoft.core.raster.buildingfootprint&cstl=hc",
